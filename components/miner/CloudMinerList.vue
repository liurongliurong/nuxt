...
<script>
  ...
  export default {
    ...
    data () {
      return {
        dataNav: {'amount': {title: '出售总数', unit: '台'}, 'one_amount_value': {title: '每台单价', unit: '元'}, 'hash': {title: '每台算力', unit: 'T'}, 'power': {title: '功耗', unit: 'T1'}, 'hashtype': {title: '算力类型', unit: ''}, 'leftNum': {title: '剩余数量', unit: '台'}},
        str: {4: '预热', 5: '热销'},
        loading: false,
        showcontent: false,
        cloudMinerDate: [],
