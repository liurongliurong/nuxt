    ...
    <h2>收益计算器</h2>
     <form @submit.prevent="submit">
      ...
      <div class="fromone">
        ...
        <span class="biao block1">请输入单台算力服务器价格</span>
      </div>
      <div class="fromone">
        <label>算力服务器数量</label>
        ...
        <span class="biao block2">请输入单台算力服务器价格</span>
      </div>
      <div class="fromone">
        <label>算力服务器算力</label>
        ...
        <span class="biao block3">请输入单台算力服务器价格</span>
      </div>
      <div class="fromone">
        <label>算力服务器功耗</label>
        <div class="rightblock">
        ...
        <span class="biao block4">请输入单台算力服务器价格</span>
      </div>
      <div class="fromone">
        <label>每T功耗</label>
      ...
      <div class="fromone">
        ...
        <span class="biao block5">请输入单台算力服务器价格</span>
      </div>
      <div class="fromone">
        <label>币价</label>
        <div class="rightblock">
        ...
        <span class="biao block6">请输入单台算力服务器价格</span>
      </div>
      <!-- <div class="fromone">
        <label>起始难度</label>
        ...
        <span class="biao block7">请输入单台算力服务器价格</span>
      </div> -->
      <div class="fromone">
        <label>开始时间</label>
  ...
  export default {
    data () {
      return {
        ...
        typebi: '¥',
        difficulty: '0',
        totallist: [{title: '总利润', prev: '¥'}, {title: '总收入', prev: '¥'}, {title: '总电费', prev: '¥'}, {title: '总算力服务器成本', prev: '¥'}, {title: '每T价格', prev: '¥'}, {title: '投资回报率', next: '%'}, {title: '当前每日收入', prev: '¥'}, {title: '当前每日电费', prev: '¥'}, {title: '当前每日利润', prev: '¥'}],
