...
<script>
  ...
  export default {
    ...
    head () {
      return {
        title: '比特币收益问题—如何比特币收益算力网',
        allid: '',
        meta: [
          { hid: 'keywords', name: 'keywords', content: '比特币收益问题' },
          { hid: 'description', name: 'description', content: '算力网收益问题大全，最细致的问题详情，最全面的问题解答，所有比特币收益爱好者的答疑天堂，经验丰富的矿工随时等你咨询。' }
        ]
      }
    },
    methods: {
