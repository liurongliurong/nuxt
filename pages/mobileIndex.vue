      ...
      <div class="page-1 page-common">
        ...
        <div class="main">
          <div class="page-number">
            <hr/>
            <p class="number">
              <i class="current-page">01</i>
              <i class="slash">/</i>
              <i class="total-page">03</i>
            </p>
          </div>
          <img class="gif" src="../assets/images/mobile/index/1.gif"/>
        </div>
        <div class="article">
      ...
      <div class="page-4 page-common">
        <header>
          ...
          <div class="login" v-else>
            <a class="iconfont" @click="goToPage('/mobile/personcenter', 3)">&#xe63f;</a>
          </div>
        </header>
        <div class="introduce">
